...
**The honest reframe for a 1M window.** 55K of definitions is ~5% of a 1M window instead of ~27% of a 200K one — so the *"you're out of room"* argument got weaker. The *cost* argument did not: those tokens are re-read and re-billed on **every turn**, and the accuracy penalty above 30–50 tools is unaffected by window size. Lead with dollars and accuracy, not with the capacity bar.
